package com.aihao.libnavcomplier;
...
@SupportedAnnotationTypes({"com.aihao.libnavannotation.ActivityDestination","com.aihao.libnavannotation.FragmentDestination"})
    ...
    private void handleDestination(Set<? extends Element> elements, Class<? extends Annotation> annotationClaz, HashMap<String, JSONObject> destMap) {
        ...
        for (Element element : elements) {
            ...
            if(destMap.containsKey(pageUrl)){
                messager.printMessage(Diagnostic.Kind.ERROR,"同一ページに同じURLを使うことができない");
            }else {
